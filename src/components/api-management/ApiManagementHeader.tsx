  ...
  return (
    <div className="flex items-center justify-between w-full border-b border-outline-variant/10 pb-8 mt-2">
      <div className="flex items-center gap-4">
        <span className="text-[22px] font-headline font-bold text-on-surface tracking-wide">API Management</span>
      ...
      <div className="flex items-center gap-7">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-[13px] text-outline font-medium tracking-wide">API Status: Operational</span>
        </div>
