...
export function HeroSection() {
    ...
    return (
        ...
        >
            ...
            <div className="w-full lg:w-[55%] h-[550px] flex justify-end relative">
                <ChatSimulation />
                {/* 
        <div className="absolute -left-4 bottom-8 lg:-left-12 lg:bottom-12 bg-surface-container-low/80 backdrop-blur-xl border border-outline-variant/20 p-6 rounded-lg shadow-2xl z-20 w-[180px]">
