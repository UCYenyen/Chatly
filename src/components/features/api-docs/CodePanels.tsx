  ...
  return (
    <>
      <div className="bg-surface-container-low border border-outline-variant/15 rounded-md overflow-hidden flex flex-col shadow-2xl">
        ...
        <div className="p-6 font-mono text-[13px] leading-[1.8] overflow-x-auto text-outline">
          <pre>
            ...
            {"\n"}
            <span className="text-secondary-fixed">{"<script"}</span>
            {"\n"}
            <span className="text-secondary-fixed">{"src="}</span>
            <span className="text-primary-fixed">
              {'"https://chatly.ai/widget.js"'}
            </span>
            {"\n"}
            <span className="text-secondary-fixed">{"data-id="}</span>
            <span className="text-primary-fixed">{'"YOUR_CHATLY_ID"'}</span>
            {"\n"}
      ...
      <div className="flex flex-col gap-4 mt-6">
        <span className="text-[11px] font-mono text-outline uppercase tracking-widest pl-4">
          Pratinjau Respons
        </span>
        <div className="bg-surface-container-low border-y border-r border-l-4 border-l-secondary-fixed border-y-outline-variant/10 border-r-outline-variant/10 p-6 rounded-r-md">
          <pre className="font-mono text-[13px] leading-[2]">
            ...
            <span className="text-on-surface">{","}</span>
            {"\n"}
            <span className="text-primary-fixed">{'"latency"'}</span>
            <span className="text-on-surface">{": "}</span>
            <span className="text-secondary-fixed">{"14ms"}</span>
            <span className="text-on-surface">{","}</span>
            {"\n"}
            <span className="text-primary-fixed">{'"stream_url"'}</span>
            <span className="text-on-surface">{": "}</span>
            <span className="text-primary-fixed">
              {'"wss://node.chatly.ai/stream"'}
            </span>
            <span className="text-on-surface">{","}</span>
            {"\n"}
            <span className="text-primary-fixed">{'"credits_remaining"'}</span>
            <span className="text-on-surface">{": "}</span>
            <span className="text-on-surface">{"14820"}</span>
            {"\n"}
            <span className="text-secondary-fixed">{"}"}</span>
          </pre>
        </div>
